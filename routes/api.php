...
Route::post('webhook/hdfc-upi', [PaymentHDFCController::class, 'webhookCallback'])->name('api.hdfc.webhook');
...
Route::group(['namespace' => 'v1', 'prefix' => 'v1', 'middleware' => ['auth:sanctum', 'checkapiuser','apiuseronline']], function () {
    ...
    // HDFC
    Route::post('payment/hdfc/init-transaction', [PaymentHDFCController::class, 'initTransaction'])->name('api.hdfc.init_transaction');
    ...
    Route::post('chat/set-disappear-mode', [ChatController::class, 'setDisappearMode'])->name('chat.set-disappear-mode');
    ...
    Route::post('game/delete-challenges',[GameChallengeController::class,'deleteChallenge'])->name('game.delete-challenges');
    // payment getway
    // instamojo 
    ...
    */
    ...
    // Coupons
    // Route::post('coupons/list', [CouponController::class, 'getCoupons'])->name('api.coupons.list');
