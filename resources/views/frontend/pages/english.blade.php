...
<html>
    <head>
        ...
        <!--Main Js Included-->
        <script type="text/javascript" src="{{ asset('frontend/js/lib/jquery-3.6.0.js') }}"></script>
        ...
        <script>
            ...
            fbq('init', '453656876665043'); 

            fbq('track', 'PageView');
        </script>
        <noscript>
            <img height="1" width="1" src="https://www.facebook.com/tr?id=453656876665043&ev=PageView &noscript=1"/>
        </noscript>
    ...
    <body>
                        ...
                        <div class="col-lg-5">
                            <div class="banner-left-box">
                                ...
                                <div class="banner-txt-wrap">
                                    ...
                                    <h4>We will be coming on both the platforms <span> iOS</span> & <span> Android </span> </h4>
                                </div>
                        ...
                        <div class="col-lg-3">
                            <div class="mobile-slider-wrapper">
                                <div class="landing-page-slider">
                                    <div>
                                            <img src="{{ asset('frontend/images/boy-mobile-eng.png') }}" alt="app-image">
                                    </div>
                                    <div>
                                            <img src="{{ asset('frontend/images/girl-mobile-eng.png') }}" alt="app-image">
                                    </div>
                                    <div>
                                            <img src="{{ asset('frontend/images/boy-mobile-eng.png') }}" alt="app-image">
                                    </div>
        ...
        <div class="footer-section @if($device) isMobile @endif">
            <div class="container">
