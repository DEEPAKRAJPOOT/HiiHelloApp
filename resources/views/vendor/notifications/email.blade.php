                    ...
                    <tr>
                        <td>
                            <table width="90%"  cellpadding="0" cellspacing="0" style="margin: 0 auto;">
                                ...
                                font-size: 16px; line-height: 22px; color: #645A8F;">Thank you for choosing Hi Hello.
                                        </p>
                                    </td>
                                </tr>
                                <tr style="height: 32px;"></tr>
                                        ...
                                        text-align: center; background-position: center; background: url('{{ asset('frontend/email-images/action-section-bg.png') }}'); background-repeat: no-repeat; background-size: cover ; border-radius: 18px;">
                                            ...
                                            <tr>
                                                <td
                                                    ...
                                                    Click Here to <br> verify your Email.</td>
                                            </tr>
                                            <tr style="height: 20px;"></tr>
                                            <tr>
                                                <td style="text-align: center;"><a href="{{ $actionUrl }}"
                                                        style="padding: 16px 20px; font-weight: 700; font-size: 14px; line-height: 17px; display: inline-block; letter-spacing: 0.032em; text-transform: uppercase;  color: #FFFFFF; text-decoration: none; background: #250A52; border-radius: 12px; width: 184px;">Verify
                                                        Now</a></td>
                                            </tr>
                                            <tr style="height: 30px;"></tr>
                                        </table>
