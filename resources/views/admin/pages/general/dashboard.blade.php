      ...
      <div class="card card-custom rounded-xl gutter-b bg-dark card-stretch">
        <div class="d-flex align-items-center mr-2">
          <div class="symbol-label px-6 py-8 rounded-xl mr-7">
            ...
            <span class="font-size-h6 text-muted font-weight-bold">Live Users</span>
          </div>
          <div>
            <div class="font-size-h1 text-white font-weight-bolder" id="live_user">{{ $user['total_live_users'] ?? 0 }}</div>
          </div>
        </div>
  ...
  $('#btn_search_filter').on('click',function(){
       ...
       if(to_date != undefined || month != undefined){
          ...
          'success':function(response){
            if(response.liveusers != false){
              $('#live_user').text(response.liveusers);
            }else{
              $('#live_user').text(0);
            }
          },
