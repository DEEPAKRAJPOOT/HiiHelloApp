            ...
            <div class="form-group col-md-12">
                <div class="form-group col-md-12 row" style="margin:15px;">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <div class="mb-2">
                            <label class="control-label">
                                <span class="mendatory" style="font-size: 20px;"></span>Occupation : 
                                <b>
                                    @if($user->occupation && $user->occupation->profileDetailTransDefault)
                                        {{ $user->occupation->profileDetailTransDefault->value }} 
                                    @else
                                        - 
                                    @endif 
                                </b>
                        ...
                        <div class="mb-2">
                            <label class="control-label">
                                <span class="mendatory" style="font-size: 20px;"></span>Date Idea : 
                                <b>
                                    @if($user->dateIdea && $user->dateIdea->profileDetailTransDefault)
                                        {{ $user->dateIdea->profileDetailTransDefault->value }} 
                                    @else
                                        - 
                                    @endif 
                                </b>
                        ...
                        <div class="mb-2">
                            <label class="control-label">
                                <span class="mendatory" style="font-size: 20px;"></span>Social Cause : 
                                <b>
                                    @if($user->socialCause && $user->socialCause->profileDetailTransDefault)
                                        {{ $user->socialCause->profileDetailTransDefault->value }} 
                                    @else
                                        - 
                                    @endif 
                                </b>
                        ...
                        <div class="mb-2">
                            <label class="control-label">
                                <span class="mendatory" style="font-size: 20px;"></span>Risk Taken : 
                                <b>
                                    @if($user->riskTaken && $user->riskTaken->profileDetailTransDefault)
                                        {{ $user->riskTaken->profileDetailTransDefault->value }} 
                                    @else
                                        - 
                                    @endif 
                                </b>
                        ...
                        <div class="mb-2">
                            <label class="control-label">
                                <span class="mendatory" style="font-size: 20px;"></span>Perfect Relation : 
                                <b>
                                    @if($user->perfectRelation && $user->perfectRelation->profileDetailTransDefault)
                                        {{ $user->perfectRelation->profileDetailTransDefault->value }} 
                                    @else
                                        - 
                                    @endif 
                                </b>
                        ...
                        <div class="mb-2">
                            <label class="control-label">
                                <span class="mendatory" style="font-size: 20px;"></span>My Mantra : 
                                <b>
                                    @if($user->myMantra && $user->myMantra->profileDetailTransDefault)
                                        {{ $user->myMantra->profileDetailTransDefault->value }} 
                                    @else
                                        - 
                                    @endif 
                                </b>
                        ...
                        <div class="mb-2">
                            <label class="control-label">
                                <span class="mendatory" style="font-size: 20px;"></span>One Thing To Know : 
                                <b>
                                    @if($user->oneThingKnow && $user->oneThingKnow->profileDetailTransDefault)
                                        {{ $user->oneThingKnow->profileDetailTransDefault->value }} 
                                    @else
                                        - 
                                    @endif 
                                </b>
                        ...
                        <div class="mb-2">
                            <label class="control-label">
                                <span class="mendatory" style="font-size: 20px;"></span>Worst Date : 
                                <b>
                                    @if($user->worstDate && $user->worstDate->profileDetailTransDefault)
                                        {{ $user->worstDate->profileDetailTransDefault->value }} 
                                    @else
                                        - 
                                    @endif 
                                </b>
                        ...
                        <div class="mb-2">
                            <label class="control-label">
                                <span class="mendatory" style="font-size: 20px;"></span>Intro With Family : 
                                <b>
                                    @if($user->introFamily && $user->introFamily->profileDetailTransDefault)
                                        {{ $user->introFamily->profileDetailTransDefault->value }} 
                                    @else
                                        - 
                                    @endif 
                                </b>
                        ...
                        <div class="mb-2">
                            <label class="control-label">
                                <span class="mendatory" style="font-size: 20px;"></span>Found The One : 
                                <b>
                                    @if($user->foundOne && $user->foundOne->profileDetailTransDefault)
                                        {{ $user->foundOne->profileDetailTransDefault->value }} 
                                    @else
                                        - 
                                    @endif 
                                </b>
                        ...
                        <div class="mb-2">
                            <label class="control-label">
                                <span class="mendatory" style="font-size: 20px;"></span>About Surprising : 
                                <b>
                                    @if($user->aboutSurprising && $user->aboutSurprising->profileDetailTransDefault)
                                        {{ $user->aboutSurprising->profileDetailTransDefault->value }} 
                                    @else
                                        - 
                                    @endif 
                                </b>
                        ...
                        <div class="mb-2">
                            <label class="control-label">
                                <span class="mendatory" style="font-size: 20px;"></span>Political View : 
                                <b>
                                    @if($user->politicalView && $user->politicalView->profileDetailTransDefault)
                                        {{ $user->politicalView->profileDetailTransDefault->value }} 
                                    @else
                                        - 
                                    @endif 
                                </b>
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <div class="mb-2">
                            <label class="control-label">
                                <span class="mendatory" style="font-size: 20px;"></span>Festivals : 
                                <b>
                                    @if($user->favFestivals->isNotEmpty())
                                        @foreach($user->favFestivals as $favFestival)
                                            @if($favFestival->festival && $favFestival->festival->profileDetailTransDefault)
                                                {{ $favFestival->festival->profileDetailTransDefault->value }}, 
                                            @endif
                                        @endforeach
                                    @else
                                        - 
