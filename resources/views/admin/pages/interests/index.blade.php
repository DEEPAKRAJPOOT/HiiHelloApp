...
@push('breadcrumb')
    {!! Breadcrumbs::render('interests_list') !!}
@endpush
        ...
        <div class="card-header">
            ...
            <div class="card-toolbar">
                @if (in_array('delete', $permissions))
                    <a href="{{ route('admin.interests.destroy', 0) }}" name="del_select" id="del_select" class="btn btn-sm btn-light-danger font-weight-bolder text-uppercase mr-2 delete_all_link">
                        <i class="far fa-trash-alt"></i> Delete Selected
                    </a>
                @endif
                @if (in_array('add', $permissions))
                    <a href="{{ route('admin.interests.create') }}" class="btn btn-sm btn-primary font-weight-bolder text-uppercase">
