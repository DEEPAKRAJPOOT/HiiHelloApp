    ...
    $(document).ready(function () {
        ...
        oTable = $('#prfile_reports_table').DataTable({
            ...
            columnDefs: [
                ...
                { targets: 0, title: 'Reporter User', orderable: true },
                { targets: 1, title: 'Reported User', orderable: true },
                { targets: 2, title: 'Message', orderable: true },
                { targets: 3, title: 'Status', orderable: true },
                { targets: 4, title: 'Date', orderable: true },
                // Action buttons
