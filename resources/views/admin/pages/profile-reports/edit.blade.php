                ...
                <div class="form-group col-md-12">
                    ...
                    <div class="form-group col-md-12">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <div class="mb-2">
                                <label class="control-label"><span class="mendatory" style="font-size: 20px;"></span>First Name : <b>@if($profile_report->reportedUser) {{ $profile_report->reportedUser->full_name }} @else - @endif </b></label>
                            </div>
                            <div class="mb-2">
