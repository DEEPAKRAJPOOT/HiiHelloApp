...
@push('breadcrumb')
    {!! Breadcrumbs::render('personality_list') !!}
@endpush
        ...
        <div class="card-header">
            ...
            <div class="card-toolbar">
                @if (in_array('delete', $permissions))
                    <a href="{{ route('admin.personalities.destroy', 0) }}" name="del_select" id="del_select" class="btn btn-sm btn-light-danger font-weight-bolder text-uppercase mr-2 delete_all_link">
                        <i class="far fa-trash-alt"></i> Delete Selected
                    </a>
                @endif
                @if (in_array('add', $permissions))
                    <a href="{{ route('admin.personalities.create') }}" class="btn btn-sm btn-primary font-weight-bolder text-uppercase">
...
<script>
    $(document).ready(function () {
        ...
        oTable = $('#users_table').DataTable({
            ...
            serverSide: true,
            ajax: {
                url: "{{ route('admin.personalities.listing') }}",
                data: {
