...
@push('breadcrumb')
    {!! Breadcrumbs::render('subscription_plans_update', $subscriptionPlan->custom_id) !!}
@endpush
...
<div class="container">
    <div class="card card-custom">
        ...
        <!--begin::Form-->
        <form id="frmEditSubscriptionPlan" method="POST" action="{{ route('admin.subscription-plans.update', $subscriptionPlan->custom_id) }}" enctype="multipart/form-data">
            @csrf
            @method('put')
            ...
            <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    value="@if(old($language->getField($language->lang_code,'name'))){{ old($language->getField($language->lang_code,'name')) }}@else{{ $subscriptionPlan->getValue($language->lang_code,'name') }}@endif"
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="{{ $language->getField($language->lang_code,'description') }}" name="{{ $language->getField($language->lang_code,'description') }}" value="@if(old($language->getField($language->lang_code,'description'))){{ old($language->getField($language->lang_code,'description')) }}@else{{ $subscriptionPlan->getValue($language->lang_code,'description') }}@endif" placeholder="Enter {{ $language->hint }} description" autocomplete="{{ $language->getField($language->lang_code,'description') }}" spellcheck="false" autocapitalize="sentences" tabindex="0" autofocus />
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="{{ $language->getField($language->lang_code,'note') }}" name="{{ $language->getField($language->lang_code,'note') }}" value="@if(old($language->getField($language->lang_code,'note'))){{ old($language->getField($language->lang_code,'note')) }}@else{{ $subscriptionPlan->getValue($language->lang_code,'note') }}@endif" placeholder="Enter {{ $language->hint }} note" autocomplete="{{ $language->getField($language->lang_code,'note') }}" spellcheck="false" autocapitalize="sentences" tabindex="0" autofocus />
            ...
            <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control @error('months') is-invalid @enderror" id="months" name="months" value="{{ old('months') != null ? old('months') : $subscriptionPlan->months }}" placeholder="Enter months" autocomplete="months" spellcheck="false" autocapitalize="sentences" tabindex="0" autofocus />
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control @error('amount') is-invalid @enderror" id="amount" name="amount" value="{{ old('amount') != null ? old('amount') : $subscriptionPlan->amount }}" placeholder="Enter amount" autocomplete="amount" spellcheck="false" autocapitalize="sentences" tabindex="0" autofocus />
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control @error('android_product') is-invalid @enderror" id="android_product" name="android_product" value="{{ old('android_product') != null ? old('android_product') : $subscriptionPlan->android_product }}" placeholder="Enter android product" autocomplete="android_product" spellcheck="false" autocapitalize="sentences" tabindex="0" autofocus />
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control @error('ios_product') is-invalid @enderror" id="ios_product" name="ios_product" value="{{ old('ios_product') != null ? old('ios_product') : $subscriptionPlan->ios_product }}" placeholder="Enter ios product" autocomplete="ios_product" spellcheck="false" autocapitalize="sentences" tabindex="0" autofocus />
                ...
                <div class="form-group">
                    ...
                    <div class="custom-file">
                        <div class="row">
                            <div class="col-md-1">
                                <input type="radio" id="y" name="is_popular" value="y" 
                                @if($subscriptionPlan->is_popular == 'y') checked @endif data-error-container="#error-authorizable">
                                <label for="Yes">Yes</label><br> 
                            </div>
                            <div class="col-md-1">
                                <input type="radio" id="n" name="is_popular" value="n" @if($subscriptionPlan->is_popular == 'n') checked @endif data-error-container="#error-authorizable">
...
$(document).ready(function () {
    $("#frmEditSubscriptionPlan").validate({
        rules: {
            '{{ $default_lang }}_name': {
                required: true,
                not_empty: true,
    ...
    $('#frmEditSubscriptionPlan').submit(function () {
        if ($(this).valid()) {
            addOverlay();
