        ...
        <form id="frmAddSubscriptionPlan" method="POST" action="{{ route('admin.subscription-plans.store') }}">
            ...
            <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control @error('day') is-invalid @enderror" id="day" name="day" value="{{ old('day') }}" placeholder="Enter day" autocomplete="day" spellcheck="false" autocapitalize="sentences" tabindex="0" autofocus />
                    @if ($errors->has('day'))
                        <span class="help-block">
