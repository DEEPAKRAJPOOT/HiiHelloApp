...
@push('breadcrumb')
    {!! Breadcrumbs::render('locations_update', $location->id) !!}
@endpush
...
<div class="container">
    <div class="card card-custom">
        ...
        <!--begin::Form-->
        <form id="frmEditLocation" method="POST" action="{{ route('admin.locations.update', $location->custom_id) }}" enctype="multipart/form-data">
            @csrf
            @method('put')
            ...
            <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    value="@if(old($language->getField($language->lang_code,'name'))){{ old($language->getField($language->lang_code,'name')) }}@else{{ $location->getValue($language->lang_code,'name') }}@endif"
...
$(document).ready(function () {
    ...
    $('#frmEditLocation').submit(function () {
        if ($(this).valid()) {
            addOverlay();
