...
return [
    ...
    */
    ...
    'swipe_over' =>  'आपकी डेली लाइक लिमिट खत्म हो गई है। जारी रखने के लिए अपग्रेड करें।',
    ...
    'subscription'    =>  [
        ...
        'pan_purchased'       =>  'यह सदस्यता योजना आपके खाते में पहले से सक्रिय है।',
        'restore'             =>  'सदस्यता सफलतापूर्वक बहाल।',
    ],
    'chat_room'  =>  [
    ...
    'notify_message'    =>  [
        ...
        'voice_call_miss_call'    =>  [
            'title'     =>  "Hi Hello",
            'message'   =>  ":entity तरफसे मिस्ड कॉल",
        ],
    ],
    'sms'   =>  [
        'message'   =>  [
