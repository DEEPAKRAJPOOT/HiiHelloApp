...
return [
    ...
    */
    ...
    'attributes' => [
        ...
        "fav_movie"             =>  "पसंदीदा फिल्म",
        "personalities"         =>  "व्यक्तित्व",
        "remove_personalities"  =>  "व्यक्तित्व हटाएं",
        "education"             =>  "शिक्षा",
        "university_college"    =>  "विश्वविद्यालय और कॉलेज",
        "profession"            =>  "पेशा",
        "religion"              =>  "धर्म",
        "relationship_status"   =>  "रिश्ते की स्थिति",
        "i_am_here"             =>  "मैं यहां",
        "food_preference"       =>  "भोजन वरीयता",
        "drinking"              =>  "पीने",
        "smoking"               =>  "धूम्रपान",
        "star_sign"             =>  "राशि",
        "community"             =>  "समुदाय",
        "old_profile_photo"     =>  "पुरानी प्रोफाइल फोटो",
        "old_images"            =>  "पुरानी तस्वीरें",
        "voice"                 =>  "आवाज़",
        "voice_answer"          =>  "आवाज का जवाब",
        "remove_voice"          =>  "आवाज हटाएं",
        "remove_video"          =>  "वीडियो हटाएं",
        "remove_image"          =>  "छवि हटाएं",
        "remove_interests"      =>  "रुचियां हटाएं",
        "image_sequence"        =>  "छवि अनुक्रम",
        "file"                  =>  "फ़ाइल",
    ],
];
