...
class Subscription extends Model
{
    ...
    protected $fillable = ['custom_id', 'email', 'user_id', 'plan_id', 'order_id', 'receipt_id', 'months', 'day', 'amount', 'start_date', 'end_date', 'payment_date', 'payment_type', 'receipt_data', 'original_transaction_id', 'status',
    "coupon_id",
    "coupon_name"
];
