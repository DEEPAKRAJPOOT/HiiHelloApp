...
class FullProfileRequest extends FormRequest
{
    ...
    public function rules($request)
    {
        ...
        return [
            ...
            'fav_festival'      =>  'nullable|in:'.implode(',', $profile_details),
            ...
            'perfect_relation'  =>  'nullable|in:'.implode(',', $profile_details),
            ...
            'intro_family'      =>  'nullable|in:'.implode(',', $profile_details),
            'found_one'         =>  'nullable|in:'.implode(',', $profile_details),
            'about_surprising'  =>  'nullable|in:'.implode(',', $profile_details),
