...
class CheckPermit
{
    ...
    public function handle($request, Closure $next)
    {
        ...
        // Permissions 
        $access = ['index', 'listing', 'showSetting', 'change-setting', 'trashed', 'trasheddata','actor-list','singer-list','unde-review','genderupdate','dashboardupdate','bulk_photo_verification'];
        $add = ['store', 'create'];
        $update = ['edit', 'update'];
        $view = ['show'];
        $delete = ['destroy'];
